...
export function FormularioDeCancha({
  ...
  return (
    <Dialog open={abierto} onOpenChange={(o) => { if (!o) onCerrar() }}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>{cancha ? `Editar ${cancha.nombre}` : 'Nueva cancha'}</DialogTitle>
        </DialogHeader>
        <form onSubmit={enviar} className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <label className="space-y-1">
              <span className="text-sm font-medium">Minutos por turno</span>
              <Input
                type="number"
                min={1}
                max={480}
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <label className="space-y-1">
              <span className="text-sm font-medium">Orden en la grilla</span>
              <Input
                type="number"
                value={datos.orden}
